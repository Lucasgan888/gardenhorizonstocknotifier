...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert prose-green">
      <h1 className="text-3xl font-bold text-green-500">Privacy Policy</h1>
      <p>Last updated: February 2026</p>
      <h2>Information We Collect</h2>
      <p>Garden Horizons Stock Notifier is a client-side application. All data is processed in your browser. We do not collect, store, or transmit any personal information.</p>
      <h2>Analytics</h2>
